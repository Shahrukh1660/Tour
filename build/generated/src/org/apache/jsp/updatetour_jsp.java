...
public final class updatetour_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String  usernamenew=session.getAttribute("user").toString();
      ...
      out.write("        \n");
      out.write("        \n");
      out.write("        <form action=\"bookc.jsp\">\n");
      out.write("            <table border=\"2\">\n");
      out.write("                <tr><td> TOUR_ID: </td> <td><input type=\"text\"name=\"n1\" value=\"");
      out.print(rs.getString(1));
      out.write("\"></td></tr>\n");
      out.write("                <tr><td> DESTINATION: </td> <td><input type=\"text\"name=\"n2\" value=\"");
      out.print(rs.getString(2));
      out.write("\"</td></tr>\n");
      out.write("                <tr><td> TOUR_DURATION : </td> <td><input type=\"text\"name=\"n3\" value=\"");
      out.print(rs.getString(3));
      out.write("\"</td></tr>\n");
      out.write("                 <tr><td> TOUR_COST : </td> <td><input type=\"text\"name=\"n4\" value=\"");
